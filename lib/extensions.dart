...
//     return where((element) => element.name.common.toLowerCase().contains(string.toLowerCase()))
//         .toList();
//   }

//   ///Whether this [Offical name] contains a match of [string].
//   List<Country>? containOfficialName(String string) {
//     return where((element) => element.name.official.toLowerCase().contains(string.toLowerCase()))
//         .toList();
//   }

//   ///Whether this [Common Name] starts with a match of [string].
//   List<Country>? startCommonName(String string) {
//     return where((element) => element.name.common.toLowerCase().startsWith(string.toLowerCase()))
//         .toList();
//   }

//   ///Whether this [Offical name] starts with a match of [string].
//   List<Country>? startOfficialName(String string) {
//     return where((element) => element.name.official.toLowerCase().startsWith(string.toLowerCase()))
//         .toList();
//   }
...
//         element.dialling!.calling_code.toLowerCase().startsWith(code.toLowerCase())).toList();
//   }

//   List<Country>? equalDialCode(String code) {
//     return where((element) => element.dialling!.calling_code.toLowerCase() == code.toLowerCase())
//         .toList();
//   }
